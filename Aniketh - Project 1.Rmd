...
```{r}
albums_gg + geom_point(aes(x=weeks_on_billboard,y=peak_billboard_position)) + labs(title='Weeks on Billboard vs Peak Billboard Position Scatter Plot', x='Weeks on Billboard',y='Peak Billboard Position')
```
